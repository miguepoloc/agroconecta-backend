...
async def list_farmers(
    ...
    compliance_status: typing.Annotated[
        typing.Optional[types.ComplianceStatus], fastapi.Query()
    ] = None,
    rank: typing.Annotated[
        typing.Optional[types.SustainabilityRank], fastapi.Query()
    ] = None,
