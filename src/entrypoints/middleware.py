...
def build_db_session_middleware(
    ...
    async def middleware(
        ...
        async with session_factory() as session:
            ...
            response = typing.cast(fastapi.Response, await call_next(request))
        return response
...
def add_exception_handlers(app: fastapi.FastAPI) -> None:
    ...
    async def handle_auth_error(
        ...
        return fastapi.responses.JSONResponse(status_code=401, content={"detail": exc.message})
    ...
    async def handle_conflict(
        ...
        return fastapi.responses.JSONResponse(status_code=409, content={"detail": exc.message})
    ...
    async def handle_order_rule(
        ...
        return fastapi.responses.JSONResponse(status_code=422, content={"detail": exc.message})
    ...
    async def handle_not_found(
        ...
        return fastapi.responses.JSONResponse(status_code=404, content={"detail": exc.message})
